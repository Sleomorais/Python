...
class AnimaisTestCase(LiveServerTestCase):
    ...
    def setUp(self):
        self.browser = webdriver.Edge(r'C:\Users\leona\Documents\tdd_busca_animal\msedgedriver.exe')
    ...
    def test_buscando_um_novo_animal(self):
        ...
        caracteristicas = self.browser.find_element(By.CSS_SELECTOR, '.result-description')
